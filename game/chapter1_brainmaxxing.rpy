# MOGMAX — Chapter 1, Act 2: Brainmaxxing
# Characters (c, h, p, b, narrator) are defined in script.rpy

default brain_score = 0
default brainmaxxing_attempt = 1
default final_score = 0
default brainmaxxing_studied = set()
default brainmaxxing_clav_quip = ""
...
image bg bully1 = bg_image("images/backgrounds/bg_bully_1.jpg")
image bg bully2 = bg_image("images/backgrounds/bg_bully_2.jpg")
image bg bully3 = bg_image("images/backgrounds/bg_bully_3.jpg")
...
label chapter1_brainmaxxing:
    ...
    $ brainmaxxing_studied = set()
    $ brainmaxxing_clav_quip = renpy.random.choice(CLAV_STUDY_QUIPS)
...
label mirror_scene:
    ...
    show screen cinematic_caption(_("{i}{size=34}You got time to be looking down?{/size}{/i}"))
    ...
    show screen cinematic_caption(_("{b}{size=34}I'm done being someone the room forgets.{/size}{/b}"))

    $ _wait_until_music_pos(89.0)
    show screen cinematic_caption(_("{b}{size=38}I'll do it until I can.{/size}{/b}"))
